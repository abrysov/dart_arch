...
import './route_search_delegate.dart';
...
class ARoute extends StatelessWidget {
  static const _frontLayerMinHeight = 128.0;
  ...
  // documentation links or reference video/article links here.
  ...
  Widget build(BuildContext context) {
    final appbarLeading = (platformType == PlatformType.Android ||
    ...
    return BackdropScaffold(
      ...
      headerHeight: _frontLayerMinHeight,
        ...
        builder: (BuildContext context) =>
            routeName == Navigator.defaultRouteName
                ...
                : WidgetWithCodeView(
                    ...
                    tabChangeListener: (TabController tabs) {
  ...
  ListView _getBackdropListTiles() {
    return ListView(
      padding: const EdgeInsets.only(bottom: _frontLayerMinHeight),
      children: <Widget>[
        ListTile(
          leading: appIcon,
